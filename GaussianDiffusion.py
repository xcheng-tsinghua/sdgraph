...
class GaussianDiffusion(Module):
    ...
    def noise_pred_loss(self, x_start, t):
        ...
        # x_0 = extract(self.sqrt_recip_alphas_bar, t, x_t.shape) * x_t - extract(self.sqrt_recip_alphas_bar_minus1, t, x_t.shape) * model_out
        # x_0.clamp_(-1., 1.)

        # return F.mse_loss(model_out, noise) + F.mse_loss(x_0, x_start)
