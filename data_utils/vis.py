...
def save_format_sketch(sketch_points, file_path, is_smooth=False, is_near_merge=False, merge_dist=0.05, side_retreat=0):
    """
    保存设定格式的草图
    ...
    :param side_retreat: 合并之前将每个笔划左右各向内删减的点数
    :return:
    """
    ...
    # 每个笔划左右各向内缩减指定数量的点
    if side_retreat > 0:
        sketch_points = sketch_points[:, 1: -1, :]
