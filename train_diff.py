...
def parse_args():
    ...
    parser.add_argument('--root_sever', type=str, default=fr'/root/my_data/data_set/quickdraw/raw/laptop.full.npz')
    parser.add_argument('--root_local', type=str, default=fr'D:\document\DeepLearning\DataSet\quickdraw\raw\laptop.full.npz')
