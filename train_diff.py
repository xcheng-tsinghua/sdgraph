    ...
    with torch.no_grad():
        ...
        for i in range(sample_epoch):
            ...
            for batch_fig_idx in range(10):
                ...
                save_format_sketch(sampled_images[batch_fig_idx], f'imgs_gen_1_0_/{save_str}-{gen_idx}.png',
                                   is_near_merge=True, retreat=(1, 0), merge_dist=args.scale * 0.1)
                save_format_sketch(sampled_images[batch_fig_idx], f'imgs_gen_1_1_/{save_str}-{gen_idx}.png',
