...
class SDGraphCls(nn.Module):
    def __init__(self, n_class: int, dropout: float = 0.4):
        ...
        # 生成初始 sdgraph
        self.point_to_sparse = PointToSparse(3, sparse_l0)
        self.point_to_dense = PointToDense(3, dense_l0)
